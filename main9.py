...
# Carregar imagens
imagem_fundo_inicial = pygame.image.load('imagens/fundo_inicial.jpg')
imagem_fundo_inicial = pygame.transform.scale(imagem_fundo_inicial, (LARGURA, ALTURA))

# Fundos específicos para cada personagem
fundos_personagens = [
    pygame.image.load('imagens/fundo_personagem1.png'),
    pygame.image.load('imagens/fundo_personagem2.png'),
    pygame.image.load('imagens/fundo_personagem3.png'),
    pygame.image.load('imagens/fundo_personagem4.png')
]

# Redimensionar fundos para o tamanho da tela
fundos_personagens = [pygame.transform.scale(fundo, (LARGURA, ALTURA)) for fundo in fundos_personagens]
...
imagem_fundo = fundos_personagens[0]
...
def exibir_menu_selecao():
    global imagem_personagem, imagem_inimigo, imagem_fundo
    fonte_menu = pygame.font.SysFont(None, 55)
    selecionado = 0
    trocando = True

    while True:
        tela.blit(imagem_fundo_inicial, (0, 0))  # Desenha o fundo inicial
        ...
        for evento in pygame.event.get():
            ...
            if evento.type == pygame.KEYDOWN:
                if evento.key == pygame.K_LEFT:
                    ...
                    imagem_fundo = fundos_personagens[selecionado]  # Atualiza o fundo de acordo com o personagem selecionado
                    return
...
while not jogo_terminado:
    tela.blit(imagem_fundo, (0, 0))  # Desenha o fundo específico do personagem selecionado
